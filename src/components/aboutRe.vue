...
import MemberCardRe from "@/components/memberCardRe.vue";
    ...
    <div class="NFTLeo_fn_content">
      ...
      <div class="NFTLeo_fn_pagetitle">
        ...
        <div class="pt_content">
          <div class="container">
            <h3 class="fn_title fn_animated_text" data-wait="1000" data-speed="8">Re</h3>
            <p class="fn_desc">
              <a href="index.html">首页</a>
              <span class="separator">/</span>
              <span class="current">Re组</span>
            </p>
          </div>
        </div>
      </div>
            ...
            <div class="NFTLeo_fn_about_item">
              ...
              <div class="content_item">
                ...
                <div class="NFTLeo_fn_title" data-align="left">
                  <h3 class="fn_title">Re in CTF</h3>
